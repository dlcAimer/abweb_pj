...
Blockly.Xml.workspaceToDom = function (a, b) {
  var c = Blockly.Xml.utils.createElement("xml"), d = Blockly.Xml.variablesToDom(Blockly.Variables.allUsedVarModels(a));
...
Blockly.WorkspaceSvg.getTopLevelWorkspaceMetrics_ = function () {
  var a = Blockly.WorkspaceSvg.getDimensionsPx_(this.toolbox_), b = Blockly.WorkspaceSvg.getDimensionsPx_(this.flyout_),
    c = Blockly.svgSize(this.getParentSvg()), d = {height: c.height, width: c.width};
...
Blockly.BlockSvg.prototype.updateColour = function () {
  if (!this.disabled) {
    var a = this.getColour(), b = this.getColourSecondary(), c = this.getColourTertiary(), d = goog.color.hexToRgb(a);
...
Blockly.BlockSvg.prototype.setBorderColour_ = function (a, b) {
  if (b) this.svgPathLight_.setAttribute("stroke", "none"), this.svgPathDark_.setAttribute("fill", "none"), this.svgPath_.setAttribute("stroke", b); else {
    ...
    var c = goog.color.rgbArrayToHex(goog.color.lighten(a, .3)), d = goog.color.rgbArrayToHex(goog.color.darken(a, .2));
...
Blockly.Css.CONTENT = [".blocklySvg {", "background-color: #fff;", "outline: none;", "overflow: hidden;", "position: absolute;", "display: block;", "}", ".blocklyWidgetDiv {", "display: none;", "position: absolute;", "z-index: 99999;", "}", ".injectionDiv {", "height: 100%;", "position: relative;", "overflow: hidden;", "touch-action: none", "}", ".blocklyNonSelectable {", "user-select: none;", "-moz-user-select: none;", "-ms-user-select: none;", "-webkit-user-select: none;", "}", ".blocklyWsDragSurface {", "display: none;",
  ...
  ".myStyle {", "display: block;", "width: 1.25rem;", "height: 1.25rem;", "border: 1px solid;", "border-radius: 100%;", "margin: 2px auto 0;", "background-color: rgb(76, 151, 255);", "border-color: rgb(51, 115, 204);", ""];
Blockly.WidgetDiv = {};
